<x-layout>
    ...
    <div class="container-fluid p-5 bg-gradient bg-revisor p-5 shadow">
        ...
        <div class="row">
            ...
            <div class="container d-flex flex-column align-items-center py-0 my-0">
                <div class="card">
                    <div class="row">
                            ...
                            <div id="showCarousel" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item @if ($loop->first) active @endif">
                                        <img src="{{ Storage::url($image->path) ?? 'https://picsum.photos/200/300' }}" class="card-img-top" alt="">
                                    </div>
                                    @endforeach
                                </div>
                                @else
                        ...
                        <h5 class="card-title mt-2 ms-1" style="font-weight: bold">Titolo: <span style="font-weight: 400">{{ $ad_to_check->title }}</span></h5>
                        <hr>
                        <p class="card-text ms-1" style="font-size: 20px; font-weight: bold">Descrizione:</p>
                        <p class="ms-1">{{ $ad_to_check->description }}</p>
                        <hr>
                        <p class="card-footer text-center">Pubblicato il: {{ $ad_to_check->created_at->format('d/m/Y') }} | Inserzionista:
                        </p>
                    </div>
                </div>
